...
export function TopBar() {
  ...
  return (
    <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-xl border-b border-[#EDD5C5]/50 shadow-[0_1px_8px_rgba(198,104,79,0.06)]">
