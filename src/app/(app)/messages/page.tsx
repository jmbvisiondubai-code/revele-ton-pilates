...
function MessagesPage() {
  ...
  // ── Desktop detection (Enter to send only on desktop) ────────────────────
  ...
  if (!isSupabaseConfigured()) {
    return (
      <div className="flex items-center justify-center h-[calc(100dvh-8.5rem-env(safe-area-inset-top,0px))] lg:h-[calc(100dvh-2rem)]">
  ...
  return (
    <div className="flex h-[calc(100dvh-8.5rem-env(safe-area-inset-top,0px))] lg:h-[calc(100dvh-2rem)] overflow-hidden">
                          ...
                          {isEditing ? (
                            <div className="flex items-end gap-1">
                              <textarea
                                ...
                                onKeyDown={e => { if (e.key === 'Enter' && !e.shiftKey && isDesktop) { e.preventDefault(); saveEdit() } if (e.key === 'Escape') setEditingId(null) }}
