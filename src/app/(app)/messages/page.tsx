...
export default function MessagesPage() {
  ...
  if (!isSupabaseConfigured()) {
    return (
      <div className="flex items-center justify-center h-[calc(100dvh-8.5rem)] lg:h-[calc(100dvh-2rem)]">
  ...
  return (
    <div className="flex h-[calc(100dvh-8.5rem)] lg:h-[calc(100dvh-2rem)] overflow-hidden">
